...
<body>
  ...
  <div id="container">
    ...
    <div class="general">
      <h1>Cute Emotional Octopus</h1>
      <h2 id="productID">octo</h2>
      <a href="BookWorld.html">
        <div class="shop">
    ...
    <div class="container" id="newShop">
      ...
      <div class="swiper-slide">
        ...
        <div class="ProductBox" onclick="location.href='Product-YourName.html'">
          <img src="../Image/Hipplush/hipplush1.jpg" alt="">
          <h3 class="ProTitle">Hipplush</h3>
          <h3 class="Author"></h3>
          <div class="prices">
            <span class="original">59.99</span>
            <span class="current">39.49</span>
          </div>
          <!--Shop/!-->
          <!--Hover Effect/!-->
      ...
      <div class="swiper-slide">
        <!--box/!-->
        <div class="ProductBox" onclick="location.href='Product-WeatheringWithYou.html'">
          <img src="../Image/IllusionCard/card1.jpg" alt="">
          <h3 class="ProTitle">Illusion Card Set</h3>
          <h3 class="Author"></h3>
          <div class="prices">
      ...
      <div class="swiper-slide">
        <!--box/!-->
        <div class="ProductBox" onclick="location.href='Product-YourName.html'">
          <img src="../Image/Otterplush/otterplush.jpg" alt="">
          <h3 class="ProTitle">Otterplush</h3>
          <h3 class="Author"></h3>
          <div class="prices">
            <span class="original">32.99</span>
            <span class="current">12.49</span>
          </div>
          <!--Shop/!-->
          <!--Hover Effect/!-->
          <div class="HoverEffect">
      ...
      <div class="swiper-slide">
        <!--box/!-->
        <div class="ProductBox" onclick="location.href='Product-WeatheringWithYou.html'">
          <img src="../Image/Doge/dogecards.jpg" alt="">
          <h3 class="ProTitle">Doge-styled card set</h3>
          <h3 class="Author"></h3>
          <div class="prices">
            <span class="original">16.99</span>
            <span class="current">14.49</span>
          </div>
          <!--Shop/!-->
          <!--Hover Effect/!-->
          <div class="HoverEffect">
